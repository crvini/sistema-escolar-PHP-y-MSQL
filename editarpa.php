...
<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-timer zmdi-hc-fw"></i> Padres <small> del Colegio</small></h1>
			</div>
			<p class="lead">Edita el padres: </p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="new">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="actualizarpa.php" method="post">
											...
											<div class="form-group label-floating">
                                              ...
                                              <input class="form-control" type="text" name="Nombre" value="<?php echo $mostrar['Nombre_Materno']?>"> 
                                               </div>
                                               <div class="form-group label-floating">
											  <label class="control-label">Apellido</label>
											  <input class="form-control" type="text" name="Apellido" value="<?php echo $mostrar['Apellido_Materno']?>">
											</div>
											<div class="form-group label-floating">
