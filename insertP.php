...
require 'conexion.php';
                ...
                && isset($_POST['Usuario']) && !empty($_POST['Usuario']) && isset($_POST['Password']) && !empty($_POST['Password']) && isset($_POST['estatus']) && !empty($_POST['estatus']) ){
                    mysqli_query($conectar,("INSERT INTO profesores (Id,Id_rol,Nombre_profesor,Apellido,Usuario,Password,Estatus) VALUES('$_POST[id]','$_POST[id_rol]','$_POST[Nombre]','$_POST[Apellido]','$_POST[Usuario]','$_POST[Password]','$_POST[estatus]')"));
